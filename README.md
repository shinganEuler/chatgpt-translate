...
async function translateWithAzureOpenAI(
    ...
    message: string,
    azure_openai_url: string,       // your custom azure openai url, like "https://YOUR_ENDPOINT_NAME.openai.azure.com/openai/deployments/YOUR_DEPLOYMENT_NAME/completions?api-version=2022-12-01"
